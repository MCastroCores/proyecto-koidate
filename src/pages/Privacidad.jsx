...
export const Privacidad = () => {
  return (
    <>
      <Header />
      <main>
        <h2 className="mx-4 text-xl text-primary font-bold text-center my-5">
          POLÍTICA DE PRIVACIDAD DEL SITIO WEB
        </h2>
        <h3 className="mx-4 text-lg text-primary font-bold text-center my-5">
          I. POLÍTICA DE PRIVACIDAD Y PROTECCIÓN DE DATOS.
        </h3>
        <p className="mx-3 my-2">
          Respetando lo establecido en la legislación vigente,
          koi-datefisioterapia.es (en adelante, también Sitio Web) se compromete
          a adoptar las medidas técnicas y organizativas necesarias, según el
        ...
        <p className="mx-3 my-2">
          ...
          koi-datefisioterapia.es: koi-date Fisioterapia, provista de
          NIF:47435811Je inscrito en: con los siguientes datos registrales:,
          cuyo representante es: koi-datefisioterapia.es(en adelante,
          Responsable del tratamiento). Sus datos de contacto son los
          siguientes:
        </p>
        <p className="mx-3 my-2">
          Dirección:Praza da Gaiteira 2, bajo izq 2, 15006, A Coruña
        </p>
        <p className="mx-3 my-2">Teléfono de contacto: 644769541</p>
        <p className="mx-3 my-2">
          Email de contacto: koidatefisioterapia@gmail.com
        </p>
        <p className="mx-3 my-2">Registro de Datos de Carácter Personal</p>
        <p className="mx-3 my-2">
          En cumplimiento de lo establecido en el RGPD y la LOPD-GDD, le
          informamos que los datos personales recabados por
          koi-datefisioterapia.es, mediante los formularios extendidos en sus
          páginas quedarán incorporados y serán tratados en nuestro fichero con
          el fin de poder facilitar, agilizar y cumplir los compromisos
          establecidos entre koi-datefisioterapia.es y el Usuario o el
          ...
          salvo que sea de aplicación la excepción prevista en el artículo 30.5
          del RGPD, se mantine un registro de actividades de tratamiento que
        ...
        <p className="mx-3 my-2">Categorías de datos personales</p>
        <p className="mx-3 my-2">
          as categorías de datos que se tratan en koi-datefisioterapia.es son
        ...
        <p className="mx-3 my-2">
          ...
          consentimiento. koi-datefisioterapia.es se compromete a recabar el
        ...
        <p className="mx-3 my-2">
          ...
          se le informará en caso de que la cumplimentación de alguno de ellos
          sea obligatoria debido a que los mismos sean imprescindibles para el
        ...
        <p className="mx-3 my-2">
          ...
          koi-datefisioterapia.es con la finalidad de poder facilitar, agilizar
          y cumplir los compromisos establecidos entre el Sitio Web y el Usuario
          o el mantenimiento de la relación que se establezca en los formularios
        ...
        <p className="mx-3 my-2">
          ...
          propias del objeto social de koi-datefisioterapia.es, así como para la
        ...
        <p className="mx-3 my-2">Destinatarios de los datos personales</p>
        <p className="mx-3 my-2">
        ...
        <p className="mx-3 my-2">Datos personales de menores de edad</p>
        <p className="mx-3 my-2">
          ...
          personales de forma lícita por koi-datefisioterapia.es. Si se trata de
          un menor de 14 años, será necesario el consentimiento de los padres o
          tutores para el tratamiento, y este solo se considerará lícito en la
          medida en la que los mismos lo hayan autorizado.
        </p>
        <p className="mx-3 my-2">Secreto y seguridad de los datos personales</p>
        <p className="mx-3 my-2">
          koi-datefisioterapia.es se compromete a adoptar las medidas técnicas y
          organizativas necesarias, según el nivel de seguridad adecuado al
          riesgo de los datos recogidos, de forma que se garantice la seguridad
          de los datos de carácter personal y se evite la destrucción, pérdida o
        ...
        <p className="mx-3 my-2">
          Sin embargo, debido a que koi-datefisioterapia.es no puede garantizar
          la inexpugabilidad de internet ni la ausencia total de hackers u otros
        ...
        <p className="mx-3 my-2">
          El Usuario tiene sobre koi-datefisioterapia.es y podrá, por tanto,
        ...
        <ul>
          <li className="list-disc mx-8">
            ...
            de si koi-datefisioterapia.es está tratando o no sus datos
            personales y, en caso afirmativo, obtener información sobre sus
            datos concretos de carácter personal y del tratamiento que
            koi-datefisioterapia.es haya realizado o realice, así como, entre
            otra, de la información disponible sobre el origen de dichos datos y
            los destinatarios de las comunicaciones realizadas o previstas de
            los mismos.
          </li>
          <li className="list-disc mx-8">
          ...
          <li className="list-disc mx-8">
            ...
            sociedad de la información a un menor de 14 años. Además de suprimir
            los datos, el Responsable del tratamiento, teniendo en cuenta la
            tecnología disponible y el coste de su aplicación, deberá adoptar
            medidas razonables para informar a los responsables que estén
          ...
          <li className="list-disc mx-8">
            ...
            Siempre que sea técnicamente posible, el Responsable del tratamiento
          ...
          <li className="list-disc mx-8">
            ...
            tratamiento de los mismos por parte de koi-datefisioterapia.es.
          </li>
          <li className="list-disc mx-8">
            ...
            sus datos personales, incluida la elaboración de perfiles, existente
        ...
        <p className="mx-3 my-2">
          ...
          referencia "RGPD-https://www.koi-datefisioterapia.es", especificando:
        </p>
        <ul className="mx-3 my-2">
          <li className="list-disc mx-8">
          ...
          <li className="list-disc mx-8">Fecha y firma del solicitante.</li>
          <li className="list-disc mx-8">
        ...
        <p className="mx-3 my-2">
          Dirección postal: Praza da Gaiteira 2, bajo izq 2, 15006, A Coruña
        </p>
        <p className="mx-3 my-2">
          Correo electrónico: koidatefisioterapia@gmail.com
        </p>
        <p className="mx-3 my-2">Enlaces a sitios web de terceros</p>
        <p className="mx-3 my-2">
          El Sitio Web puede incluir hipervínculos o enlaces que permiten
          acceder a páginas web de terceros distintos de
          koi-datefisioterapia.es, y que por tanto no son operados por
          koi-datefisioterapia.es. Los titulares de dichos sitios web dispondrán
          de sus propias políticas de protección de datos, siendo ellos mismos,
          en cada caso, responsables de sus propios ficheros y de sus propias
          prácticas de privacidad.
        </p>
        <p className="mx-3 my-2">Reclamaciones ante la autoridad de control</p>
        <p className="mx-3 my-2">
        ...
        <p className="mx-3 my-2">
          koi-datefisioterapia.es se reserva el derecho a modificar su Política
          de Privacidad, de acuerdo a su propio criterio, o motivado por un
          cambio legislativo, jurisprudencial o doctrinal de la Agencia Española
          de Protección de Datos. Los cambios o actualizaciones de esta Política
          de Privacidad no serán notificados de forma explícita al Usuario. Se
