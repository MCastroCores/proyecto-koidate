  ...
  return (
    <>
      ...
      <main className="flex flex-col gap-5 justify-center items-center mx-3">
        ...
        <h3 className="text-xl md:text-2xl font-bold bg-primary text-blanco py-2 px-4 rounded-full">
          TELÉFONO: 644769541
        </h3>
        <h3 className="text-xl md:text-2xl font-bold bg-primary text-blanco py-2 px-4 rounded-full">
          koidatefisioterapia@gmail.com
        </h3>
        <h2 className="text-4xl font-bold text-center mt-10">
          O RELLENA ESTE FORMULARIO Y NOS PONDREMOS EN CONTACTO:
        </h2>
        <ContainerContacto />
        <WhatsUpButton />
      </main>
